 ...
 */ function T(t) {
    ...
    if (E.logLevel <= e.DEBUG) {
        var i = n.map(D);
        E.debug.apply(E, w([ "Firestore (8.2.9): " + t ], i));
    }
}
...
function N(t) {
    ...
    if (E.logLevel <= e.ERROR) {
        var i = n.map(D);
        E.error.apply(E, w([ "Firestore (8.2.9): " + t ], i));
    }
}
...
function A(t) {
    ...
    if (E.logLevel <= e.WARN) {
        var i = n.map(D);
        E.warn.apply(E, w([ "Firestore (8.2.9): " + t ], i));
    }
}
...
//# sourceMappingURL=prebuilt-9c082ab3-2c01f4bf.js.map
