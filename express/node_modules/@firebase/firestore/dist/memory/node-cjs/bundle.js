...
function loadBundle(data) {
    return database1e650bf6.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return database1e650bf6.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new database1e650bf6.Query$1(this, 
...
registerBundle(database1e650bf6.Firestore);
