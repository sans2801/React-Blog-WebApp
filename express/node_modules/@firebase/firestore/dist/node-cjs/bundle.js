...
function loadBundle(data) {
    return database3f89c5da.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    var _this = this;
    return database3f89c5da.namedQuery(this._delegate, queryName).then(function (expQuery) {
        if (!expQuery) {
            return null;
        }
        return new database3f89c5da.Query$1(_this, 
...
registerBundle(database3f89c5da.Firestore);
