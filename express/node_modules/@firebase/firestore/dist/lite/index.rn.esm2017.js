 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const y = "ok", E = "cancelled", I = "unknown", T = "invalid-argument", A = "deadline-exceeded", P = "not-found", R = "already-exists", V = "permission-denied", g = "unauthenticated", b = "resource-exhausted", v = "failed-precondition", N = "aborted", $ = "out-of-range", D = "unimplemented", F = "internal", S = "unavailable", x = "data-loss";
...
function it(t) {
    ...
    // https://github.com/googleapis/googleapis/blob/master/google/rpc/code.proto
      ...
      default:
        return t >= 200 && t < 300 ? y : t >= 400 && t < 500 ? v : t >= 500 && t < 600 ? F : I;
    }
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function bt(t, n) {
    const e = gt(t);
    if (e !== gt(n)) return !1;
    switch (e) {
      case 0 /* NullValue */ :
      ...
      case 9 /* ArrayValue */ :
        return lt(t.arrayValue.values || [], n.arrayValue.values || [], bt);

      case 10 /* ObjectValue */ :
        return function(t, n) {
            const e = t.mapValue.fields || {}, s = n.mapValue.fields || {};
            if (_t(e) !== _t(s)) return !1;
            for (const t in e) if (e.hasOwnProperty(t) && (void 0 === s[t] || !bt(e[t], s[t]))) return !1;
            return !0;
        }
...
function vt(t, n) {
    return void 0 !== (t.values || []).find((t => bt(t, n)));
}
...
function nn(t, n) {
    ...
    for (let e = 0; e < t.position.length; e++) {
        if (!bt(t.position[e], n.position[e])) return !1;
    }
    return !0;
}
...
function hn(t, n) {
    return function(t, n) {
        ...
        e.op !== s.op || !e.field.isEqual(s.field) || !bt(e.value, s.value)) return !1;
        var e, s;
...
class Hn extends class {} {
    ...
    En() {
        if (this.yn) throw new q(v, "The client has already been terminated.");
    }
 ...
 */
function ne(t) {
    if (t.In) throw new q(v, "The client has already been terminated.");
    if (!te.has(t)) {
 ...
 */ class ee {
    ...
    constructor(t, n) {
        ...
        this.Rn = new C) : (this.bn = t, this.Tn = function(t) {
 ...
 */ (t), this.Rn = new L(n));
     ...
     * instance.
     */    get app() {
        if (!this.bn) throw new q(v, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.bn;
    }
    get vn() {
        return this.gn;
    ...
    $n(t) {
        if (this.gn) throw new q(v, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
...
/** Parse document data from a set() call. */ function ve(t, n, e, s, r, i = {}) {
...
/** Parse update data from an update() call. */ function qe(t, n, e, s) {
    ...
    const u = new mt(i);
    return new Pe(o.vt(), u, r.fieldTransforms);
}
...
/** Parse update data from a list of field/value arguments. */ function Oe(t, n, e, s, r, i) {
    ...
    const l = new mt(a);
    return new Pe(h.vt(), l, o.fieldTransforms);
}
...
class ts extends Ze {
    ...
    ce(t) {
        const n = be(t.firestore), e = function(t, n, e, s, r, i, o) {
            let u;
            if (r.Y()) {
...
function Ts(t, n, e) {
    const s = ps((t = Z(t, ce)).Sn, n, e), r = ve(be(t.firestore), "setDoc", t.xn, s, null !== t.Sn, e);
    return Kn(ne(t.firestore), [ r.Mn(t.xn, yn.Qt()) ]);
}

function As(t, n, e, ...s) {
    const r = be((t = Z(t, ce)).firestore);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
        let i;
 ...
 */ function Rs(t, n) {
    const e = de(t = Z(t, he)), s = ps(t.Sn, n), r = ve(be(t.firestore), "addDoc", e.xn, s, null !== e.Sn, {});
 ...
 */ class $s {
    /** @hideconstructor */
    constructor(t, n) {
        this.se = t, this.Ve = n, this.ge = [], this.be = !1, this.ve = be(t);
    }
    set(t, n, e) {
        this.Ne();
        const s = Ds(t, this.se), r = ps(s.Sn, n, e), i = ve(this.ve, "WriteBatch.set", s.xn, r, null !== s.Sn, e);
    ...
    update(t, n, e, ...s) {
        ...
        // performing validation.
                let i;
        return n instanceof ue && (n = n.et), i = "string" == typeof n || n instanceof pe ? Oe(this.ve, "WriteBatch.update", r.xn, n, e, s) : qe(this.ve, "WriteBatch.update", r.xn, n), 
    ...
    Ne() {
        if (this.be) throw new q(v, "A write batch can no longer be used after commit() has been called.");
    }
}
...
class Cs {
    /** @hideconstructor */
    constructor(t, n) {
        this.se = t, this._s = n, this.ve = be(t);
    }
    /**
    ...
    set(t, n, e) {
        const s = Ds(t, this.se), r = ps(s.Sn, n, e), i = ve(this.ve, "Transaction.set", s.xn, r, null !== s.Sn, e);
    ...
    update(t, n, e, ...s) {
        ...
        // performing validation.
                let i;
        return n instanceof ue && (n = n.et), i = "string" == typeof n || n instanceof pe ? Oe(this.ve, "Transaction.update", r.xn, n, e, s) : qe(this.ve, "Transaction.update", r.xn, n), 
