...
import { StorageReference, StorageService, UploadResult, ListOptions, ListResult, UploadTask, FirebaseStorageError, TaskEvent, TaskState, StorageObserver, SettableMetadata, UploadMetadata, FullMetadata } from '@firebase/storage-types/exp';
/**
 * Public types.
 */
export { StorageReference, StorageService, UploadMetadata, SettableMetadata, FullMetadata, UploadResult, ListOptions, ListResult, UploadTask, FirebaseStorageError, TaskEvent, TaskState, StorageObserver };
/**
